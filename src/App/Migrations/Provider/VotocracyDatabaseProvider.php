...
namespace App\Migrations\Provider;

use App\Entity\Enum\ElectionModel;
use App\Entity\Enum\ElectionStatus;
use App\Entity\Enum\ElectionVisible;
...
class VotocracyDatabaseProvider implements SchemaProvider
{
    /**
